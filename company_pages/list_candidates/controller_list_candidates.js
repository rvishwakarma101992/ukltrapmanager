...
angular
.module('inspinia')
.controller('controller_list_candidates', ['$scope','service_vswf', '$state', 'DTColumnDefBuilder','$rootScope', '$timeout',controller_list_candidates])
;
function controller_list_candidates($scope, service_vswf, $state, DTColumnDefBuilder,$rootScope,$timeout){
